...
BEGIN_MESSAGE_MAP(CAudioCompressionPage, CMFCPropertyPage)
...
CAudioCompressionPage::CAudioCompressionPage(LPUNKNOWN pUnk, HRESULT *phr, LPCTSTR strTitle) :
	CMFCPropertyPage(_T("ACMPage"), pUnk, IDD, strTitle)
{
	// retval
	if (phr) *phr = NOERROR;
	streamconfig = NULL;
